//
// Generated file, do not edit! Created by nedtool 5.6 from MyMsg.msg.
//
...
MyMSG::MyMSG(const char *name, short kind) : ::omnetpp::cMessage(name,kind)
{
    this->source = 0;
}

MyMSG::MyMSG(const MyMSG& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
int MyMSG::getSource() const
{
    return this->source;
}

void MyMSG::setSource(int source)
{
    this->source = source;
}

const char * MyMSG::getData() const
{
    return this->data.c_str();
}

void MyMSG::setData(const char * data)
{
    this->data = data;
}
...
MyMSGDescriptor::MyMSGDescriptor() : omnetpp::cClassDescriptor("MyMSG", "omnetpp::cMessage")
{
...
int MyMSGDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    MyMSG *pp = (MyMSG *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *MyMSGDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string MyMSGDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 1: return oppstring2string(pp->getData());
        default: return "";
    }
}

bool MyMSGDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *MyMSGDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
